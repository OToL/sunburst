...
public:
    ...
    void FillTestArray(VectorOfPOD & test_vector, wstd::true_type const & /* push */ = wstd::true_type{})
    {
    ...
    void FillTestArray(VectorOfPOD & test_vector, wstd::false_type const &)
    {
        for (usize idx = 0; idx != test_vector.capacity(); ++idx)
        {
    ...
    void FillTestArray(VectorOfNonPOD & test_vector, wstd::true_type const & /* push */ = wstd::true_type{})
    {
        for (usize idx = 0; idx != test_vector.capacity(); ++idx)
        {
    ...
    void FillTestArray(VectorOfNonPOD & test_vector, wstd::false_type const &)
    {
        for (usize idx = 0; idx != test_vector.capacity(); ++idx)
        {
...
{
    {
        ...
        FillTestArray(test_vector, wstd::false_type{});
    }
