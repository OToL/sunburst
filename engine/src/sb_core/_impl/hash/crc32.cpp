...
sb::u32 sb::computeCRC32(slw::span<u8 const> const &buffer)
{
    u32 crc_value = 0U;
...
sb::u32 sb::computeCRC32(slw::string_view_fw const &buffer)
{
    u32 crc_value = 0U;
...
sb::u32 sb::computeCRC32(char const * const str)
{
    ...
    while ('\0' != *iter)
    {
        crc_value = CRC32_TAB[(crc_value ^ *iter) & 0xff] ^ (crc_value >> 8);
        ++iter;
    }
