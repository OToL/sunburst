...
template <typename TEnum, typename ... TEnums> requires sbstdx::are_same_v<TEnum, TEnums...>
inline constexpr auto makeEnumMaskValue(TEnum val, TEnums ... others)
{
    using ValueType = sbstd::underlying_type_t<TEnum>; 
...
template <typename TEnum, typename ... TEnums> requires sbstdx::are_same_v<TEnum, TEnums...>
inline constexpr EnumMask<TEnum> makeEnumMask(TEnum val, TEnums ... others)
{
    return EnumMask<TEnum>{makeEnumMaskValue(val, others...)};
}

template <typename TEnum, typename ... TEnums> requires sbstdx::are_same_v<TEnum, TEnums...>
inline constexpr bool hasEnumValues(EnumMask<TEnum> enum_mask, TEnums ... values)
{
...
template <typename TEnum, typename ... TEnums> requires sbstdx::are_same_v<TEnum, TEnums...>
inline constexpr bool hasAnyEnumValue(EnumMask<TEnum> enum_mask, TEnums ... values)
{
