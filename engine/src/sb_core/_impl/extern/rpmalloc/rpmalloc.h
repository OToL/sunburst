...
#define RPMALLOC_GROW_OR_FAIL 2
    ...
    typedef struct rpmalloc_global_statistics_t
    {
        ...
        size_t huge_alloc;
        //! Peak amount of memory allocated in huge allocations, i.e larger than LARGE_SIZE_LIMIT which is 2MiB by
        //! default (only if ENABLE_STATISTICS=1)
    ...
    RPMALLOC_EXPORT RPMALLOC_ALLOCATOR void * rpmalloc(size_t size) RPMALLOC_ATTRIB_MALLOC
    ...
    RPMALLOC_EXPORT RPMALLOC_ALLOCATOR void * rpaligned_realloc(void * ptr, size_t alignment, size_t size,
                                                                size_t oldsize,
    ...
    //  sizeof(void*), and should ideally be less than memory page size. A caveat of rpmalloc internals is that this
    //  must also be strictly less than the span size (default 64KiB).
