...
void TestObjectCnt::initSequence(wstd::span<TestObjectCnt> objects, usize start_id)
{
...
bool TestObjectCnt::areSequencial(wstd::span<TestObjectCnt> objects, usize start_id)
{
    usize obj_id = start_id;
