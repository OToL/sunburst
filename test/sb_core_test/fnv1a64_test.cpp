...
{
    REQUIRE(0ULL == computeFNV1a64(nullptr, 0));
    REQUIRE(0ULL == computeFNV1a64((ui8 const * const) "Hello", 0));
    REQUIRE(0ULL == computeFNV1a64(""));
}

TEST_CASE("Raw buffer FNV64 hash", "[fnv64]")
{
    ui64 const fnv_val = computeFNV1a64(FNV64_ARRAY_TEST, sbstd::size(FNV64_ARRAY_TEST));
